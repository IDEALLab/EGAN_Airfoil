...
from models.cmpnts import InfoDiscriminator1D, BezierGenerator, AdaptiveCost
...
def assemble_new_gan(dis_cfg, gen_cfg, egan_cfg, device='cpu'):
    ...
    adaptive_cost = AdaptiveCost(discriminator)
    egan = BezierSEGAN(generator, discriminator, cost_func=adaptive_cost, **egan_cfg) # cost_func=adaptive_cost,
    return egan
...
if __name__ == '__main__':
    ...
    dis_cfg, gen_cfg, egan_cfg, cz = read_configs('adaptive')
    # data_fname = '../data/airfoil_interp.npy'
    data_fname = '../data/train.npy'
    save_dir = '../saves/adacost'
